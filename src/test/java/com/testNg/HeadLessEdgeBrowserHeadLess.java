...
public class HeadLessEdgeBrowserHeadLess extends library_BusinessFunctions {
	WebDriver driver;
	@Test(priority = 0)
	public void ExecutingInEdgeBrowserHeadLess() throws IOException {
		ReadingPropertyFile();
	...
	@Test(priority = 1, dependsOnMethods = { "ExecutingInEdgeBrowserHeadLess" })
